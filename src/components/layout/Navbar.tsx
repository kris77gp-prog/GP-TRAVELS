        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4 relative z-[110]">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    {/* Admin Specific Controls - Only visible when logged in */}
                    {session && (
                        <>
            ...
            {/* Mobile Nav Overlay - Ultimate 2026 Glassmorphic Design */}
            <div
                className={cn(
            ...
            >
                {/* Decorative background glow for the menu */}
                ...
                <div className="relative w-full max-w-sm flex flex-col gap-5 text-center animate-in fade-in slide-in-from-top-4 duration-500">
                    ...
                    {/* Mobile Admin Controls - Compact Style */}
                    {session && (
